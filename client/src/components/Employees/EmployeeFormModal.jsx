...
const OCR_CONFLICT_HELP =
  "Данные отличаются от распознанных. Проверьте правильность.";
const OCR_DEBUG_PREFIX = "[EmployeeOCR]";
const OCR_SUPPORTED_FILE_TYPES = [
  "passport",
  "patent_front",
  "patent_back",
  "kig",
...
const normalizePassportNumberForCompare = (value) =>
  normalizeString(value).replace(/[^\d]/g, "");

const formatPassportNumberForForm = ({ series, number }) => {
...
const formatFieldValueForDisplay = (fieldName, value, citizenships = []) => {
...
const toDebugObject = (objectValue = {}) =>
  Object.fromEntries(
...
const resolveOcrDocumentTypeByFile = (fileDocumentType, passportTypeValue) => {
...
const extractPassportSeriesAndNumber = (passportNumberValue) => {
...
const buildMvdPrefillValues = (checkType, employeeFormValues = {}) => {
  ...
  const blankRaw = normalizeString(
    employeeFormValues.blankNumber,
  ).toUpperCase();
