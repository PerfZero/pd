...
import { getOtComments, createOtComment } from '../controllers/otComment.controller.js';
...
router.post('/documents/:id/template', upload.single('file'), fixFilenameEncoding, uploadOtDocumentTemplate);
router.get('/documents/:id/template', downloadOtDocumentTemplate);

// Templates
router.get('/templates', getOtTemplates);
router.post('/templates', upload.single('file'), fixFilenameEncoding, createOtTemplate);
...
router.post('/instructions', upload.single('file'), fixFilenameEncoding, createOtInstruction);
router.get('/instructions/:id/file', downloadOtInstructionFile);

// Contractor documents
router.get('/contractor-docs', getOtContractorDocuments);
router.post('/contractor-docs', upload.single('file'), fixFilenameEncoding, uploadOtContractorDocument);
...
router.post('/contractor-status/:counterpartyId/:siteId/override', overrideOtContractorStatus);
router.post('/contractor-status/:counterpartyId/:siteId/recalculate', recalculateOtContractorStatus);
